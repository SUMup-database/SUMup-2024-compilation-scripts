...
metadata = {
    'T3': {
        'file': '2019_2021_T3_Temp_100m.csv',
        'latitude': 69 + 46.902 / 60,
        'longitude': -(47 + 40.102 / 60),
        'elevation': 1779
    },
    'CP': {
        'file': '2019_CP_Temp_100m.csv',
...
for site in ['T3','CP']:   
    ...
    for col in df_aws.columns[1:]:
        ...
        df_aws[f'depth_{depth_value}'] = int(depth_value)
